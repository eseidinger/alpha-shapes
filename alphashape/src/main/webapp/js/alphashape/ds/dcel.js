...
(function(ds, geom) {
    ...
    alphashape.ds.EdgeList.prototype = {
        ...
        removeZeroLengthEdges: function() {
            this.halfEdges.forEach(function(halfEdge) {
                if (halfEdge.origin.coordinates.equals(halfEdge.twin.origin.coordinates)) {
                    halfEdge.unchain();
                }
            });
            this.halfEdges = this.halfEdges.filter(function(halfEdge) {
                return !halfEdge.origin.coordinates.equals(halfEdge.twin.origin.coordinates);
            });
        }
    };
    ...
    alphashape.ds.Vertex.prototype = {
        constructor: ds.Vertex
    };
    ...
    alphashape.ds.HalfEdge.prototype = {
        ...
        /**
         * Get first of consecutive half edges. If half edges form a circle, the successor of this half edge is
         * returned.
         *
        ...
        /**
         * Get last of consecutive half edges. If half edges form a circle, the predecessor of this half edge is
         * returned.
         *
        ...
        getLineSegment: function() {
            return new geom.LineSegment(this.origin.coordinates, this.twin.origin.coordinates);
        },
        /**
