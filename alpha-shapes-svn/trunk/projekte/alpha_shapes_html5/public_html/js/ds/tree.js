...
(function() {
    ...
    TreeNode.prototype = {
         ...
         *
         * @param {alphashape.ds.TreeNode} node to look for in left subtree
         ...
         *
         * @param {alphashape.ds.TreeNode} node to look for in right subtree
         * @returns {boolean} true if node is contained, false otherwise
         */
         ...
         *
         * @param {alphashape.ds.TreeNode} node to add as left child
         */
         ...
         *
         * @param {alphashape.ds.TreeNode} node to add as right child
         */
         ...
         *
         * @returns {Array.<alphashape.ds.TreeNode>}
         */
        inorderList: function() {
            var result = [];
            this.inorderDo(function(node) {result.push(node)});
            return result;
        },
        /**
         ...
         * in inorder order.
         *
         * @param {function(alphashape.ds.TreeNode)} fct to execute on tree nodes
         */
         ...
         *
         * @private
         * @param {alphashape.ds.TreeNode} treeNode
         */
    ...
    Tree.prototype = {
         ...
         *
         * @param {alphashape.ds.TreeNode} oldNode to replace
         * @param {alphashape.ds.TreeNode} newNode replacement
         */
         ...
         *
         * @param {function(alphashape.ds.TreeNode)} fct to perform
         */
        inorderDo: function(fct) {
            if (this.root !== null) {
         ...
         *
         * @param {alphashape.ds.TreeNode} node1 first node to check for common ancestor
         * @param {alphashape.ds.TreeNode} node2 second node to check for common ancestor
         * @returns {alphashape.ds.TreeNode}
         */
