...
(function(Vector, LineSegment, Triangle, Circle, EdgeList, Constants, ComparatorFunctions) {
    /**
     ...
     * @constructor
     */
    alphashape.algo.Skyum = function() {};
     ...
     * @type Array.<alphashape.geom.Vector>
     */
    alphashape.algo.Skyum.delaunayPoints;
     ...
     */
    alphashape.algo.Skyum.initTriangleArray = function(points) {
        Skyum.triangles = [];
    ...
    alphashape.algo.Skyum.calcVP = function(P, Q) {
        ...
        return C.add(v.normalize().multiplyScalar(Constants.INFINITY));
    };
    ...
    alphashape.algo.Skyum.handleTriangle = function(triangle) {
        if (Skyum.smallestCircle === null &&
            !((ComparatorFunctions.compareWithTolerance(triangle.getMiddleAngle(),
                Math.PI / 2) === 1))) {
     ...
     * @param {alphashape.geom.Vector} C coordinates of the vertex of the two Voronoi edges separating
     *                  P, Q and R
     * @param {alphashape.geom.Vector} vP coordinates of the vertex of the Voronoi edge separating
     *                  P and R
     * @param {alphashape.geom.Vector} vQ cooridnates of the vertex of the Voronoi edge separating
     *                  P and Q
     */
     ...
     * @param {alphashape.geom.Vector} vQ coordinates of one vertex of the Voronoi edge separating
     *                  Q and R
     * @param {alphashape.geom.Vector} vR coordinates of other vertex of the Voronoi edge separating
     *                  Q and R
     */
     ...
     */
    alphashape.algo.Skyum.configureVertexForPoint = function(coordinates, incidentEdge, face1,
                                             face2) {
...
})(alphashape.geom.Vector, alphashape.geom.LineSegment, alphashape.geom.Triangle, alphashape.geom.Circle,
        alphashape.ds.EdgeList, alphashape.util.Constants, alphashape.util.ComparatorFunctions);
